...
Die *Mac-Demo* zeigt dieselben Beispiel-Renderings an wie die Original-[X-Windows-Demo](#x-windows-demo), funktioniert aber anders. Es wird für jedes Beispiel ein `out.pdf` mithilfe von imagemagick und/oder ghostscript erstellt und das dann mit der macOS Vorschau App angezeigt.
